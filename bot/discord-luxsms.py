...
TOKEN = "MTE4OTkzMzMxNzY4OTE5NjY4NQ.GlFt2C.JD6oaFbgjjCYTLtLzI_t47M5wEjLZ2Pxg8yW-s"
...
async def on_ready():
    ...
    activity = discord.Activity(type=discord.ActivityType.playing, name="https://github.com/Lukee31/")
